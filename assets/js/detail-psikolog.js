...
const getDataPsikolog = async () => {
    ...
    psikolog.forEach(function(item) {
        ...
        `<div class="col-md-5 mb-5">
            <div class="row">
                <img src="https://www.w3schools.com/w3css/img_avatar3.png" alt="${item.name}"
                    class="img-fluid img-manual" />
            </div>
            <div class="row text-center mt-4 mb-3">
                <div class="col-lg-6 border-lg-end">
                    <p class="h3">Pengalaman</p>
                    <p class="fs-5">${item.pengalaman} Tahun</p>
                </div>
                <div class="col-lg-6">
                    <p class="h3">Harga</p>
            ...
            <div class="row">
                <div class="d-grid gap-2 col-md-8 mx-auto">
                    <a class="btn btn-primary" href="pembayaran.html?id=${item.id}">Konsultasi dengan ${item.name}</a>
                </div>
            </div>
        </div>
        <div class="col-md-7" id="detail">
            ...
            <div class="row py-3">
                <h6>Jadwal Praktik : ${item.schedule}</h6>
